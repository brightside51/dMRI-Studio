...
def trainer(args: Namespace) -> None:
    ...
    #np.savetxt('/home/sapap9/PythonCode/MUDI/runs/textfiles/K=500_epoch=10000_test_' + '11' + '_dec.txt', np.array(model.get_indices(), dtype=int), fmt='%d')
    np.savetxt('/home/sapap9/PythonCode/MUDI/runs/textfiles/K=500_epoch=5000_test_' + str(args.val_subj) + '_dec.txt', np.array(model.get_indices(), dtype=int), fmt='%d')
